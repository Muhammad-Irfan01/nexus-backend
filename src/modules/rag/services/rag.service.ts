...
export class RagService {
    ...
    constructor( private Prisma: PrismaService, private retrival: RetrivalService, private promprbuilder: PromptBuilderService) {}

    async ask(question: string, workspaceId: string) {
